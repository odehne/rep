...
Partial Public Class tblItem
    ...
    End Sub
    Partial Private Sub OnTrailerChanging(value As String)
    End Sub
    Partial Private Sub OnTrailerChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_Trailer", DbType:="XML Null")>  _
	Public Property Trailer() As String
		Get
			Return Me._Trailer
		End Get
		Set
			If (String.Equals(Me._Trailer, value) = false) Then
				Me.OnTrailerChanging(value)
				Me.SendPropertyChanging
				Me._Trailer = value
				Me.SendPropertyChanged("Trailer")
				Me.OnTrailerChanged
			End If
		End Set
	End Property
